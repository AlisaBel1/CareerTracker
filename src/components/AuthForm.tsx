  ...
  return (
    <div className="flex flex-col gap-4 p-8 rounded-xl shadow-lg bg-white w-full max-w-md">
      ...
      <button
        ...
        disabled={loading}
        className="w-full bg-white hover:bg-gray-50 text-gray-700 p-3 rounded-lg font-medium border border-gray-300 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
      >
